    ...
    <div class="text-center">
      ...
      <section>
        ...
        <ul class="col-6 offset-3 text-start">
          ...
          <li>
            Using technologies like React, MongoDB, MYSQL, Node.js, Web APIs,
            Express.js to further develop applications, projects and web pages.
          </li>
          <li>Command-line to navigate through folders and files.</li>
          <li>
            Using Command-line with Visual Studio Code to build and run code for
            projects
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul class="col-6 offset-3 text-start">
          ...
          <li>
            Being part of a team, having my own responsibilities as well as
            making sure the salon works as a whole.
          </li>
          <li>
            Creating a safe environment for dogs to get their nails trimmed,
            bathed and a great haircut.
          </li>
          <li>
            Making sure every dog leaves looking and feeling good in a timely
            manner.
          </li>
          <li>
            Providing excellent customer service by offering multiple options
            best suiting the dog's and the pet parent's needs.
          </li>
        </ul>
      </section>
      <br></br>
      <section>
        ...
        <ul class="col-6 offset-3 text-start">
          ...
          <li>
            First in (getting dogs organized and sorted into appropriate groups)
          </li>
          <li>
            Last out (making sure all tasks are accomplished and facility is
            clean)
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul class="col-6 offset-3 text-start">
          ...
          <li>
            Working with school camps and tours in the education department
          </li>
          <li>
            Building enclosures, painting, making sure the building and
            enclosures are safe for the animals.
          </li>
        </ul>
      </section>
      <br></br>
